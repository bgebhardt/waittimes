...
# This was the original clean data script required before I quoted the strings in the csv file.
#  why did I not do that sooner?  Didn't notice it until I had all my initial data and had to 
# work around that mistake with the crazy sed stuff below.
